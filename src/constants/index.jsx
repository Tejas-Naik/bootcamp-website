...
//     title: "Work smarter code better",
//     text: "Learn from a self-taught developer with over 4 years of experience. Our bootcamps will transform your coding journey, making complex topics easy and practical.",
//     button: {
...
//     text: "With real-time guidance and 24/7 support, you’ll always have the help you need to succeed in both Python and Web Development.",
//     button: {
...
export const faq = [
  {
    id: "0",
    question: "How do the live coding classes work?",
    answer:
      "Each course includes daily 2-hour live sessions where you'll learn by building real-world projects. You'll also have access to recordings of every class.",
  },
  {
    id: "1",
    question: "Can I join the bootcamp if I'm a beginner?",
    answer:
      "Absolutely! Both the Python Pro Bootcamp and Web Development Bootcamp are beginner-friendly, and we'll start from the basics to help you build a strong foundation.",
  },
  {
    id: "2",
    question: "What if I miss a class?",
    answer:
      "No worries! All live classes are recorded, and you'll have full access to the recordings so you can catch up at any time.",
  },
  {
    id: "3",
    question: "Do I get a certificate after completing the bootcamp?",
    answer:
      "Yes! Upon successful completion of the course, you'll receive a certificate that you can share with potential employers or on LinkedIn.",
  },
  {
    id: "4",
    question: "What do I need to participate in the classes?",
    answer:
      "You'll need a computer with internet access, and for some classes, you'll also need to install software like Python or a code editor. We'll guide you through everything.",
  },
  {
    id: "5",
    question: "Can I ask questions during the live sessions?",
    answer:
      "Yes, we encourage it! You can ask questions during the live sessions, and we also provide personalized feedback on your coding progress.",
  },
  {
    id: "6",
    question: "Are the classes interactive?",
    answer:
      "Definitely! Our live sessions are highly interactive, with coding challenges, project building, and real-time collaboration with the instructor and peers.",
  },
  {
    id: "7",
    question: "Do you offer any discounts for students?",
    answer:
      "Yes, we offer special discounts for students. Please reach out to us to learn more about available discounts and offers.",
  },
  {
    id: "8",
    question: "What projects will I build during the bootcamp?",
    answer:
      "You'll build various real-world projects such as a portfolio website, web apps, and Python automation tools. Each course is designed to provide hands-on experience with industry-relevant projects.",
  },
  {
    id: "9",
    question: "How can I get help if I'm stuck on a project?",
    answer:
      "If you're stuck, you can reach out to the instructor or join the community forum where other students and instructors can help guide you through any challenges.",
  },
];
...
export const features = [
  {
    ...
    title: "Code Smarter, Achieve More",
    text: "Join a journey led by a developer with 4+ years of experience. Our bootcamps simplify tough coding concepts, offering real-world solutions.",
    button: {
      icon: "/images/magictouch.svg",
      title: "Watch the demo",
    },
  },
  {
    ...
    text: "Benefit from expert support and real-time guidance 24/7 as you master Python and Web Development.",
    button: {
      icon: "/images/docs.svg",
...
export const details = [
  ...
  },
  {
    id: "2",
    icon: "/images/detail-3.png",
    title: "Lightning Fast Cloud Engine",
  },
  {
    id: "3",
    icon: "/images/detail-4.png",
...
export const plans = [
  {
    ...
    priceMonthly: 99,
    priceYearly: 899,
    caption: "Master Python in 100 Days",
    features: [
      "100 Days of Live Classes",
  ...
  {
    id: "2",
    title: "Full Coding Package",
    priceMonthly: 159,
    priceYearly: 1399,
    caption: "Get the Best of Both Courses",
    features: [
      "All Python & Web Dev Features",
      "Full Access to Both Bootcamps",
      "Extended Support",
      "Exclusive Bonus Projects",
    ],
